...
public class Block6 implements Block{
	private int x,y;
	private int rot;
	...
	public Block6(){
		...
		blockColor = 2; 
		//blockColor = r.nextInt(2)+1; 
		
		//HIORZ
		//Blocko.igrid[x][y]=blockColor;
		//Blocko.igrid[x][y+1]=blockColor;
		//Blocko.igrid[x][y+2]=blockColor;
		//Blocko.igrid[x+1][y+2]=blockColor;
	}
